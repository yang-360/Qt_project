...
void treeWidget::init()
{
    ...
    //第二个分组
    QTreeWidgetItem *group2 = new QTreeWidgetItem(ui->treeWidget_2);
...
void treeWidget::treeItemChanged(QTreeWidgetItem *item, int column)
{
...
void treeWidget::updateParentItem(QTreeWidgetItem *item)
{
    QTreeWidgetItem * parent = item->parent();
    if(parent == NULL)
    {
